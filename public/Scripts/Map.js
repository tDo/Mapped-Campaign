...
// Cusotm map type used to cache, retrieve and handle the custom tiles
// generated by GMapImageCutter tool
function CustomMapType(tilesPath) {
    this.cache     = Array();
    this.opacity   = 1.0;
    this.tilesPath = tilesPath;

    // name of the map type
    this.name      = "Image Cutter";
    this.alt       = "Image Cutter Tiles";
...
function Map(mapId, mapContainerDomId) {
